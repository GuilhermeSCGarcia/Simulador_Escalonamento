...
class InterfaceSimulador:
    ...
    def desenhar_gantt(self):
        ...
        legend_elements = [
            ...
            Line2D([0], [0], color='#C0392B', marker='P', linestyle='None', markersize=8, label='Lock Mutex'),
            Line2D([0], [0], color='#8E44AD', marker='P', linestyle='None', markersize=8, label='Lock Mutex Bloqueio'),
            Line2D([0], [0], color='#27AE60', marker='o', linestyle='None', markersize=8, label='Unlock Mutex'),
            Line2D([0], [0], color='#1F77B4', marker='s', linestyle='None', markersize=8, label='Inicio E/S'),
            Line2D([0], [0], color='#17A589', marker='D', linestyle='None', markersize=8, label='fim E/S'),
